          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg text-left animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Isi informasi cabang baru</p>
                </div>
              </div>
              <button
                onClick={() => setOpen(false)}
            ...
            >
              <div>
                ...
                <input name="nama" placeholder="mis. Jakarta" required className={inputClass} />
              </div>
              ...
              <div>
                ...
                <input name="kota" placeholder="mis. Jakarta Timur" className={inputClass} />
              </div>
